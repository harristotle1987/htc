...
export default function TermsOfService({ onBack }: TermsOfServiceProps) {
  return (
    <div className="flex-1 overflow-y-auto custom-scrollbar p-6 lg:p-12 max-w-4xl mx-auto">
      <motion.button
        initial={{ opacity: 0, x: -20 }}
        animate={{ opacity: 1, x: 0 }}
        onClick={onBack}
        className="flex items-center gap-2 text-muted hover:text-primary mb-8 transition-colors group"
      >
